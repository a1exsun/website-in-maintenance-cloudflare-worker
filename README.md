...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/website-maintenance
```

A live public deployment of this template is available at [https://website-maintenance.templates.workers.dev](https://website-maintenance.templates.workers.dev)
